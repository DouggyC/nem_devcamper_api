...
exports.login = asyncHandler(async (req, res, next) => {
  ...
  if (!isMatch) next(new ErrorResponse("Invalid pw credentials", 401));
...
// @desc          PUT Update user details name and email
...
exports.resetPassword = asyncHandler(async (req, res, next) => {
  ...
  if (!user) next(new ErrorResponse("Invalid token", 400));
